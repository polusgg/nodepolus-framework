...
export class Player implements PlayerInstance {
  ...
  async setVisionModifier(visionModifier: number): Promise<void> {
    await this.entity.getPlayerControl().sendRpcPacket(new PolusSetVisionModifierPacket(visionModifier));

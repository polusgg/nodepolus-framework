...
const TASKS_AIRSHIP: readonly Readonly<LevelTask>[] = [
  ...
  { id: 3, name: "Vault Room: Download Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 4, name: "Brig: Download Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 5, name: "Cargo Bay: Download Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 6, name: "Gap Room: Download Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 7, name: "Records: Download Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  ...
  { id: 13, name: "Main Hall: Develop Photos", isVisual: false, length: TaskLength.Long, type: TaskType.DevelopPhotos },
  ...
  { id: 25, name: "Electrical: Divert Power to Cockpit", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 26, name: "Electrical: Divert Power to Gap Room", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 27, name: "Electrical: Divert Power to Main Hall", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 28, name: "Electrical: Divert Power to Meeting Room", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 29, name: "Electrical: Divert Power to Showers", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 30, name: "Electrical: Divert Power to Engine", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },

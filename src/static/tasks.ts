...
const TASKS_AIRSHIP: readonly Readonly<LevelTask>[] = [
  ...
  { id: 3, name: "Vault Room: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 4, name: "Brig: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 5, name: "Cargo Bay: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  ...
  { id: 8, name: "Cargo Bay: Unlock Safe", isVisual: false, length: TaskLength.Long, type: TaskType.UnlockSafe },
  { id: 9, name: "Ventilation: Start Fans", isVisual: false, length: TaskLength.Long, type: TaskType.StartFans },
  { id: 10, name: "Main Hall: Empty Garbage", isVisual: false, length: TaskLength.Long, type: TaskType.EmptyGarbage },
  ...
  { id: 14, name: "Cargo Bay: Fuel Engines", isVisual: false, length: TaskLength.Long, type: TaskType.FuelEngines },
  { id: 15, name: "Security: Rewind Tapes", isVisual: false, length: TaskLength.Long, type: TaskType.RewindTapes },
  { id: 16, name: "Vault Room: Polish Ruby", isVisual: false, length: TaskLength.Short, type: TaskType.PolishRuby },
  ...
  { id: 23, name: "Viewing Deck: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  ...
  { id: 33, name: "Vault Room: Dress Mannequin", isVisual: false, length: TaskLength.Short, type: TaskType.DressMannequin },
  ...
  { id: 37, name: "Main Hall: Decontaminate", isVisual: false, length: TaskLength.Short, type: TaskType.Decontaminate },

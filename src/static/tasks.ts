...
const TASKS_AIRSHIP: readonly Readonly<LevelTask>[] = [
  ...
  { id: 1, name: "MeetingRoom: Enter Id Code", isVisual: false, length: TaskLength.Common, type: TaskType.EnterIdCode },
  { id: 2, name: "Electrical: Reset Breakers", isVisual: false, length: TaskLength.Long, type: TaskType.ResetBreakers },
  { id: 3, name: "VaultRoom: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 4, name: "Brig: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 5, name: "CargoBay: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 6, name: "GapRoom: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 7, name: "Records: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 8, name: "CargoBay: Unlock Safe", isVisual: false, length: TaskLength.Long, type: TaskType.UnlockSafe },
  { id: 9, name: "Ventilation: Start Fans", isVisual: false, length: TaskLength.Long, type: TaskType.StartFans },
  { id: 10, name: "MainHall: Empty Garbage", isVisual: false, length: TaskLength.Long, type: TaskType.EmptyGarbage },
  { id: 11, name: "Medical: Empty Garbage", isVisual: false, length: TaskLength.Long, type: TaskType.EmptyGarbage },
  { id: 12, name: "Kitchen: Empty Garbage", isVisual: false, length: TaskLength.Long, type: TaskType.EmptyGarbage },
  { id: 13, name: "MainHall: Develop Photos", isVisual: false, length: TaskLength.Long, type: TaskType.DevelopPhotos },
  { id: 14, name: "CargoBay: Fuel Engines", isVisual: false, length: TaskLength.Long, type: TaskType.FuelEngines },
  { id: 15, name: "Security: Rewind Tapes", isVisual: false, length: TaskLength.Long, type: TaskType.RewindTapes },
  { id: 16, name: "VaultRoom: Polish Ruby", isVisual: false, length: TaskLength.Short, type: TaskType.PolishRuby },
  { id: 17, name: "Electrical: Calibrate Distributor", isVisual: false, length: TaskLength.Long, type: TaskType.CalibrateDistributor },
  { id: 18, name: "Cockpit: Stabilize Steering", isVisual: false, length: TaskLength.Short, type: TaskType.StabilizeSteering },
  { id: 19, name: "Armory: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 20, name: "Cockpit: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 21, name: "Comms: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 22, name: "Medical: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 23, name: "ViewingDeck: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 24, name: "Electrical: Divert Power", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 25, name: "Electrical: Divert Power", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 26, name: "Electrical: Divert Power", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 27, name: "Electrical: Divert Power", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 28, name: "Electrical: Divert Power", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 29, name: "Electrical: Divert Power", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 30, name: "Electrical: Divert Power", isVisual: false, length: TaskLength.Short, type: TaskType.DivertPower },
  { id: 31, name: "Showers: Pick Up Towels", isVisual: false, length: TaskLength.Short, type: TaskType.PickUpTowels },
  { id: 32, name: "Lounge: Clean Toilet", isVisual: false, length: TaskLength.Short, type: TaskType.CleanToilet },
  { id: 33, name: "VaultRoom: Dress Mannequin", isVisual: false, length: TaskLength.Short, type: TaskType.DressMannequin },
  { id: 34, name: "Records: Sort Records", isVisual: false, length: TaskLength.Short, type: TaskType.SortRecords },
  { id: 35, name: "Armory: Put Away Pistols", isVisual: false, length: TaskLength.Short, type: TaskType.PutAwayPistols },
  { id: 36, name: "Armory: Put Away Rifles", isVisual: false, length: TaskLength.Short, type: TaskType.PutAwayRifles },
  { id: 37, name: "MainHall: Decontaminate", isVisual: false, length: TaskLength.Short, type: TaskType.Decontaminate },
  { id: 38, name: "Kitchen: Make Burger", isVisual: false, length: TaskLength.Short, type: TaskType.MakeBurger },
  { id: 39, name: "Showers: Fix Shower", isVisual: false, length: TaskLength.Short, type: TaskType.FixShower },
];

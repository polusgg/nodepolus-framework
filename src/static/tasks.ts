...
const TASKS_SUBMERGED: readonly Readonly<LevelTask>[] = [
  ...
  { id: 15, name: "Electrical: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 16, name: "Security: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 17, name: "Storage: Upload Data", isVisual: false, length: TaskLength.Long, type: TaskType.UploadData },
  { id: 18, name: "Observatory: Align Telescope", isVisual: false, length: TaskLength.Short, type: TaskType.AlignTelescope },
  { id: 19, name: "Upper Central: Clean Glass", isVisual: false, length: TaskLength.Short, type: TaskType.CleanGlass },
  { id: 20, name: "Filtration: Dispense Water", isVisual: false, length: TaskLength.Short, type: TaskType.DispenseWater },
  { id: 21, name: "Meeting Room: Feed Pet Fish", isVisual: false, length: TaskLength.Short, type: TaskType.FeedPetFish },
  { id: 22, name: "Research: Identify Specimen", isVisual: false, length: TaskLength.Short, type: TaskType.IdentifySpecimen },
  { id: 23, name: "Observatory: Locate Volcanic Activity", isVisual: false, length: TaskLength.Short, type: TaskType.LocateVolcanicActivity },
  { id: 24, name: "Cafeteria: Purchase Breakfast", isVisual: false, length: TaskLength.Short, type: TaskType.PurchaseBreakfast },
  { id: 25, name: "Filtration: Reconnect Piping", isVisual: false, length: TaskLength.Short, type: TaskType.ReconnectPiping },
  { id: 26, name: "Electrical: Reset Breakers", isVisual: false, length: TaskLength.Short, type: TaskType.RestartBreakers },
  { id: 27, name: "Ballast: Start Submersible", isVisual: false, length: TaskLength.Short, type: TaskType.StartSubmersible },
  { id: 28, name: "Medical: Steady Heartbeat", isVisual: false, length: TaskLength.Short, type: TaskType.SteadyHeartbeat },
  { id: 29, name: "Meeting Room: Track Manta Ray", isVisual: false, length: TaskLength.Short, type: TaskType.TrackManta },
  { id: 30, name: "Engine Room: Unlock Manifolds", isVisual: false, length: TaskLength.Short, type: TaskType.UnlockManifolds },
  { id: 31, name: "Storage: Sort Scuba Gear", isVisual: false, length: TaskLength.Short, type: TaskType.SortScubaGear },
  { id: 32, name: "Engine Room: Cycle Reactor", isVisual: false, length: TaskLength.Short, type: TaskType.CycleReactor },
];

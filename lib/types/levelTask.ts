...
export const TASKS_THE_SKELD: LevelTask[] = [
  ...
  { id: 13, name: "O2: Clean O2 Filter", isVisual: false, length: TaskLength.Short, type: TaskType.Filter },
...
export const TASKS_MIRA_HQ: LevelTask[] = [
  ...
  { id: 14, name: "Greenhouse: Clean O2 Filter", isVisual: false, length: TaskLength.Short, type: TaskType.Filter },

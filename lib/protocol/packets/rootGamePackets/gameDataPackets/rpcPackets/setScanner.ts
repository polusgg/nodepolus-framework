...
export class SetScannerPacket extends BaseRPCPacket {
  constructor(public readonly isScanning: boolean, public readonly sequenceId: number) {
  ...
  serialize(): MessageWriter {
    return new MessageWriter().writeBoolean(this.isScanning).writeByte(this.sequenceId);
  }
}
